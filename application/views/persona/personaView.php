...
<body>
    ...
    <div class="container">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="p-2 m-0"><?php echo $row->apellido ?></td>
                        <td class="p-2 m-0"><?php echo $row->ci ?></td>
                        <td class="p-2 m-0"><?php echo $row->telefonos ?></td>
                        <td class="p-2 m-0"><?php echo $row->direccion ?></td>
                        <td class="p-2 m-0"><?php echo $row->observaciones ?></td>
                        ...
                        <td class="p-2 m-0">
                            ...
                            echo form_open_multipart('personaController/modificarPersonaView', $atributos);
                            ?>
                        ...
                        <td class="p-2 m-0">
                            ...
                            echo form_open_multipart('personaController/eliminarPersona', $atributos);
                            ?>
                            <input type="hidden" name="idPERSONA" value="<?php echo $row->idPERSONA ?>">
        ...
        <div>
            <?php
            $atributos = array('class' => 'from-group', 'id' => 'crearNuevaPersona');
            echo form_open_multipart('personaController/crearPersonaView', $atributos);
            ?>
