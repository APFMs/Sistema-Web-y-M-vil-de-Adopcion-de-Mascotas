...
<body>
    ...
    <div class="container text-center">
        <div class="row">
            ...
            <div class="col-sm-4">
                <h2>
                    <strong class="text-center">CREACION DE UNA NUEVA PERSONA</strong>
                </h2>
                <br>
                <?php
                $atributos = array('class' => 'form-group', 'id' => 'crearNuevaPersona');
                echo form_open_multipart('personaController/crearPersonaBD', $atributos);
                ?>
                ...
                <div class="form-floating">
                    <input id="apellidoPaterno" class="form-control" type="text" name="apellidoPaterno" value="" required><br>
                    <label for="apellidoPaterno">PRIMER APELLIDO</label>
                </div>
                <div class="form-floating">
                    <input id="apellidoMaterno" class="form-control" type="text" name="apellidoMaterno" value="" required><br>
                    <label for="apellidoMaterno">SEGUNDO APELLIDO</label>
                </div>
                <div class="form-floating">
                    <input id="ci" class="form-control" type="text" name="ci" value="" required><br>
                    <label for="ci">CEDULA DE IDENTIDAD</label>
                </div>
                <div class="form-floating">
                    <input id="telefonos" class="form-control" type="text" name="telefonos" value="" required><br>
                ...
                <div class="form-floating">
                    <input id="observaciones" class="form-control" type="text" name="observaciones" value="" required><br>
