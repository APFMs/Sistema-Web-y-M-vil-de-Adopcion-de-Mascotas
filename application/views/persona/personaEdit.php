    ...
    <div clas="container text-center">
        <div class="row">
            ...
            <div class="col-sm-4 text-center">
                <h2>
                    <strong>EDICIÓN DE PERSONAS</strong>
                </h2>
                <br>
                <?php
                $atributos = array('class' => 'form-group', 'id' => 'editarPersona');
                echo form_open_multipart('personaController/guardarPersonaBD', $atributos);
                ?>
                <?php
                ...
                ?>
                    ...
                    <div class="form-floating">
                        <input id="nombre" class="form-control" type="text" name="nombre" value="<?php echo $row->nombre ?>" required><br>
                        <label for="nombre">NOMBRE</label>
                    </div>
                    <div class="form-floating">
                        <input id="apellidoPaterno" class="form-control" type="text" name="apellidoPaterno" value="<?php echo $row->apellidoPaterno ?>" required><br>
                        <label for="apellidoPaterno">PRIMER APELLIDO</label>
                    </div>
                    <div class="form-floating">
                        <input id="apellidoMaterno" class="form-control" type="text" name="apellidoMaterno" value="<?php echo $row->apellidoMaterno ?>" required><br>
                        <label for="apellidoMaterno">SEGUNDO APELLIDO</label>
                    </div>
                    <div class="form-floating">
                        <input id="ci" class="form-control" type="text" name="ci" value="<?php echo $row->ci ?>" required><br>
                        <label for="ci">CEDULA DE IDENTIDAD</label>
                    </div>
                    <div class="form-floating">
                        <input id="telefonos" class="form-control" type="text" name="telefonos" value="<?php echo $row->telefonos ?>" required><br>
                        <label for="telefonos">TELEFONO</label>
                    </div>
                    <div class="form-floating">
                        <input id="direccion" class="form-control" type="text" name="direccion" value="<?php echo $row->direccion ?>" required><br>
                        <label for="direccion">DIRECCION</label>
                    </div>

                    <div class="form-floating">
                        <input id="observaciones" class="form-control" type="text" name="observaciones" value="<?php echo $row->observaciones ?>" required><br>
