    ...
    <div class="container">
        ...
        <table class="table table-bordered table-responsive-md table-striped">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <td class="p-2 m-0"><?php echo $row->nombreUsuario ?></td>
                        <td class="p-2 m-0"><?php echo $row->rol ?></td>
                        <td class="p-2 m-0"><?php echo $row->fechaCreacion ?></td>
                        <td class="p-2 m-0"><?php echo $row->fechaActualizacion ?></td>

                        <td class="p-2 m-0">
                            <?php
                            $atributos = array('class' => 'form-group', 'id' => 'editarUsuario');
                            echo form_open_multipart('usuarioController/modificarUsuarioView', $atributos);
                            ?>
                        ...
                        <td class="p-2 m-0">
                            ...
                            echo form_open_multipart('usuarioController/eliminarUsuario', $atributos);
                            ?>
                            <input type="hidden" name="idUSUARIO" value="<?php echo $row->idUSUARIO ?>">
        ...
        <div>
            ...
            echo form_open_multipart('usuarioController/crearUsuarioView', $atributos);
            ?>
