    ...
    <div clas="container text-center">
        <div class="row">
            ...
            <div class="col-sm-4 text-center">
                <h2>
                    <strong>EDICIÓN DE FUNDACIONES</strong>
                </h2>
                <br>
                <?php
                $atributos = array('class' => 'form-group', 'id' => 'editarFundacion');
                echo form_open_multipart('fundacionController/guardarFundacionBD', $atributos);
                ?>
                <?php
                foreach ($infoFundacion->result() as $row) {
                ?>
                    <input type="hidden" name="idFUNDACION" value="<?php echo $row->idFUNDACION ?>">

                    <div class="form-floating">

                        <input class="form-control" id="nombre" type="text" name="nombre" value="<?php echo $row->nombre ?>">
                        <label for="nombre">NOMBRE DE LA FUNDACION</label>
                    </div>
                    <br>
                    <div class="form-floating">
                        <input class="form-control" id="direccion" type="text" name="direccion" value="<?php echo $row->direccion ?>">
                        <label for="direccion">DIRECCION</label>
                    </div>
                    <br>
                    <div class="form-floating">

                        <input class="form-control" id="telefonos" type="text" name="telefonos" value="<?php echo $row->telefonos ?>">
