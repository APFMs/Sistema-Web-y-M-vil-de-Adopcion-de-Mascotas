...
<body>
    ...
    <div class="container">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="p-2 m-0"><?php echo $row->edad ?></td>
                        <td class="p-2 m-0"><?php echo $row->sexo ?></td>
                        <td class="p-2 m-0"><?php echo $row->color ?></td>
                        <td class="p-2 m-0"><?php echo $row->caracteristicas ?></td>
                        <td class="p-2 m-0"><?php echo $row->tamanio ?></td>
                        ...
                        <td class="p-2 m-0">
                            ...
                            echo form_open_multipart('mascotaController/modificarMascotaView', $atributos);
                            ?>
                        ...
                        <td class="p-2 m-0">
                            ...
                            echo form_open_multipart('mascotaController/eliminarMascota', $atributos);
                            ?>
                            <input type="hidden" name="idMASCOTA" value="<?php echo $row->idMASCOTA ?>">
        ...
        <div>
            <?php
            $atributos = array('class' => 'from-group', 'id' => 'crearNuevaMascota');
            echo form_open_multipart('mascotaController/crearMascotaView', $atributos);
            ?>
