    ...
    <div clas="container text-center">
        <div class="row">
            ...
            <div class="col-sm-4 text-center">
                <h2>
                    <strong>EDICIÓN DE MASCOTAS</strong>
                </h2>
                <br>
                <?php
                $atributos = array('class' => 'form-group', 'id' => 'editarMascota');
                echo form_open_multipart('mascotaController/guardarMascotaBD', $atributos);
                ?>
                <?php
                foreach ($infoMascota->result() as $row) {
                ?>
                    ...
                    <div class="form-floating">
                        <input id="edad" class="form-control" type="text" name="edad" value="<?php echo $row->edad ?>" required><br>
                    ...
                    <br>
                    <div class="form-floating">
                        <input id="color" class="form-control" type="text" name="color" value="<?php echo $row->color ?>" required><br>
                        <label for="color">COLOR</label>
                    </div>
                    <div class="form-floating">
                        <input id="caracteristicas" class="form-control" type="text" name="caracteristicas" value="<?php echo $row->caracteristicas ?>" required><br>
                        <label for="caracteristicas">CARACTERISTICAS</label>
                    </div>

                    <div class="form-floating">
                        <input id="tamanio" class="form-control" type="text" name="tamanio" value="<?php echo $row->tamanio ?>" required><br>
